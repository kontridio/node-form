...
app.post('/save', urlencodedParser, (req, res) => {
    ...
    let str = `${req.body.jmeno}, ${req.body.prijmeni}, ${req.body.singer}, ${req.body.song}, ${req.body.vyber}, ${req.body.platform}, ${req.body.bladee}, ${date}\n`;
...
app.get("/vysledky", (req, res) => {
    csvtojson({headers:['jmeno','prijmeni','singer','song','vyber','platforma','bladee','date']}).fromFile(path.join(__dirname, 'data/vysledky.csv'))
        .then(data => {
            console.log(data)
